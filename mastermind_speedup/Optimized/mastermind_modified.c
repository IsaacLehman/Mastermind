 ...
 * 
 * COMPILE & EXECUTE
 * gcc -Og mastermind_modified.c score_codes_modified_obj.s -lm 
 * time ./a.out     To run a timed execution
 * 
 * *****************************************************************/
#include <stdio.h>
#include <stdlib.h>
...
********************************************************************/
void scoreCodes( Code secretCode,  CodePtr guessCode); // linked in assembly
